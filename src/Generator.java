...
public class Generator {
	...
	static String state="";
	public static Double[] genData(int n,int date){
		if(date<1||date>12) {
		...
		Double[] data = {stromverbrauch, (double) strompreis, emission, stromimport, stromexport};
		return data;
	}
	/**
	 * @throws SQLException
	...
	public static String generate(int n,int date) {
		Double[] resdata=genData(n,date);
		int preis= resdata[1].intValue();
		String result="INSERT INTO testdata " + "VALUES ('"+state+"',0.0,"+resdata[0]+","+preis+","+resdata[2]+","+resdata[3]+","+resdata[4]+","+date+")";
	...
	public static String generateNew(int n,int date) {
		...
		String result="UPDATE testdata SET stromverbrauch='"+resdata[0]+"',strompreis='"+preis+
				"',CO2Emissionen="+resdata[2]+",Stromimport="+resdata[3]+",Stromexport="+resdata[4]+
